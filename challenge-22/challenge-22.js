(function () {
  ...
  */
  ...
  console.log(getFullName.call(beca));
  console.log(getFullName.call(gui));
  ...
  */
  ...
  console.log(sum(42, 20, 80, 93, 2018));
  ...
  */
  ...
  var userEntryNumber = justNumbers(userEntry);
  ...
  */
  ...
  console.log(sum.apply(sum, userEntryNumber));
