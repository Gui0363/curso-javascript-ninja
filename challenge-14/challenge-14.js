...
*/
  ...
  var nomeLinguaDoPe = nome.reduce(function (x, y) {
    return x + "P" + y;
  }, "");
  console.log('\nSeu nome na língua do "P":');
  console.log(nomeLinguaDoPe);

  /*
Crie uma variável chamada `inversedName`, que reduzirá o array em uma string
e atribuirá o seu nome invertido (usando o array criado acima).
*/
  var inversedName = nome.reduceRight(function (x, y, index, array) {
    return x + y;
  });
  console.log("\nInversed Name:");
...
*/
  ...
  console.log(
    "Fizemos uma pesquisa com .indexOf() e conseguimos encontrar o número "
  );
