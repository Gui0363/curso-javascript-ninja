(function () {
  ...
  */
  var sul = ['Rio Grande do Sul', 'Santa Cataria', 'Paraná'];
  var sudeste = ['São Paulo', 'Minas Gerais', 'Rio de Janeiro',
    'Espírito Santo'
  ];
  ...
  */
  var nordeste = ['Maranhão', 'Ceará', 'Piauí', 'Bahia', 'Sergipe', 'Alagoas',
  ...
  */
  ...
  var duvida1 = brasil.every(function (item) {
  ...
  */
  ...
  if (temCeara) {
    console.log('Ceará está incluso!')
  } else {
  ...
  */
  var retorno = map.filter(function (item, index) {
    return item.id % 2 === 0
  });
